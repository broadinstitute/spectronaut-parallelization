...
task convert_htrms {
    ...
    command <<<
        ...
        echo "=== Converting HTRMS files using broadcptacdev/panoply_spectronaut:v19.0 ===" >&2
        ...
        echo "=== Finished converting HTRMS files using broadcptacdev/panoply_spectronaut:v19.0 ===" >&2
    >>>
    ...
    runtime {
        docker: "broadcptacdev/panoply_spectronaut:v19.0"
...
task spectronaut {
    ...
    command <<<
        ...
        echo "=== Spectronaut analysis task started (broadcptacdev/panoply_spectronaut:v19.0) ===" >&2
        ...
        echo "=== Spectronaut search complete (broadcptacdev/panoply_spectronaut:v19.0) ===" >&2
    >>>
